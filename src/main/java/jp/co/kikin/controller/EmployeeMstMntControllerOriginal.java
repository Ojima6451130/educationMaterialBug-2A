...
import jp.co.kikin.service.EmployeeMstMntLogicOriginal;
...
public class EmployeeMstMntControllerOriginal {
    /** 社員マスタメンテ画面検索URL */
    ...
    private String view(PROCCESS_TYPE init, HttpServletRequest req, HttpSession session, EmployeeMstMntForm form, Model model)
            throws Exception {
        // 社員マスタのデータを取得する。
        EmployeeMstMntLogicOriginal employeeMstMntLogicOriginal = new EmployeeMstMntLogicOriginal();
        ...
        // 社員情報を取得する
        Collection<EmployeeMstMntDto> m_employeeList = employeeMstMntLogicOriginal.getEmployeeData(loginUserDto);
    ...
    public String update(HttpServletRequest request, HttpSession session,
        ...
        // 更新・削除処理
        employeeMstMntLogicOriginal.updateM_employee(m_employeeDtoList, loginUserDto);

        // 社員情報を再検索する
        m_employeeDtoList = employeeMstMntLogicOriginal.getEmployeeData(loginUserDto);
